...
#define MBED_CONF_NORDIC_NRF_LF_CLOCK_SRC                                     NRF_LF_SRC_XTAL                                                                                  // set by target:MCU_NRF51_UNIFIED
#define MBED_CONF_NORDIC_UART_HWFC                                            1                                                                                                // set by target:MCU_NRF51_UNIFIED
